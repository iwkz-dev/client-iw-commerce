          ...
          <div className="relative px-6 py-12 md:py-20 md:px-12 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
              ...
              <p className="text-lg opacity-80 mb-6">
                Sate Somay a.k.a SASO, salah satu event Bazar makanan Indonesia terbesar di Berlin-Jerman yang diiniasi oleh Jamaah Masjid Al-Falah IWKZ e.V..
              </p>
              <p  className="text-lg opacity-80 mb-6">Acara ini bertujuan untuk menggalang dana operasional Masjid Al Falah dengan menjual beranega ragam makanan khas Indonesia. Selain dijadikan moment untuk bersilaturahmi sesama masyarakat Indonesia, SASO juga menjadi ajang promosi kuliner kepada masyarakat Jerman.</p>
            ...
            <div className="md:w-1/2 flex justify-center">
              <Image src="/iwkz_logo.png" alt="Picture of the IWKZ Logo" width={300} height={200} />
            </div>
          </div>
        </div>
      </div>
